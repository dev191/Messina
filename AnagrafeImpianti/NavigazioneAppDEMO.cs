...
// Type: TheSite.AnagrafeImpianti.NavigazioneAppDEMO
...
namespace TheSite.AnagrafeImpianti
{
  public class NavigazioneAppDEMO : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      NavigazioneAppDEMO.FunId = int.Parse(this.Request["FunId"]);
      NavigazioneAppDEMO.HelpLink = siteModule.HelpLink;
      ...
      if (this.Request.QueryString["FromWebCad"] != null || this.Request.QueryString["FromWebCad"].ToString() != string.Empty)
      {
        if (this.Request.QueryString["WebCadIndietro"] != null)
          this.BntIndietro.Visible = true;
    ...
    private void BntIndietro_Click(object sender, EventArgs e) => this.Server.Transfer("DataRoom.aspx?FunId=" + (object) NavigazioneAppDEMO.FunId + "&FromWebCad=" + this.Request["FromWebCad"]);
  }
}
