...
// Type: TheSite.ManutenzioneProgrammata.SfogliaRdlOdlPaging
...
{
  public class SfogliaRdlOdlPaging : Page
  {
    ...
    protected LinkButton FirstPage;
    protected LinkButton PreviousPage;
    protected LinkButton NextPage;
    protected LinkButton LastPage;
    protected HtmlGenericControl PagingLink;
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      SfogliaRdlOdlPaging.FunId = siteModule.ModuleId;
      SfogliaRdlOdlPaging.HelpLink = siteModule.HelpLink;
    ...
    private void BindStatoLavoro(string idstato)
    {
      ...
      DataSet statoLavoro = new TheSite.Classi.ManProgrammata.SfogliaRdlOdlPaging("").GetStatoLavoro();
    ...
    private void Ricerca(bool reset)
    {
      ...
      ((ParameterObject) sObject15).set_Value((object) 1);
      ...
      ((ParameterObject) sObject16).set_Value((object) this.DataGrid1.PageSize);
      CollezioneControlli.Add(sObject16);
      TheSite.Classi.ManProgrammata.SfogliaRdlOdlPaging sfogliaRdlOdlPaging = new TheSite.Classi.ManProgrammata.SfogliaRdlOdlPaging(this.Context.User.Identity.Name);
      DataSet data = sfogliaRdlOdlPaging.GetData(CollezioneControlli);
      this.CurrentPage.Text = this._currentPageNumber.ToString();
      double a;
      if (reset)
      {
        int num = sfogliaRdlOdlPaging.Update(CollezioneControlli, 0);
        this.GridTitle1.NumeroRecords = num.ToString();
        a = (double) (num / this.DataGrid1.PageSize);
        this.TotalPages.Text = Math.Ceiling(a).ToString();
      }
      else
        a = double.Parse(this.TotalPages.Text);
      ...
      else
      {
        ...
        if ((double) this._currentPageNumber == a)
          this.NextPage.Enabled = false;
        else
          this.NextPage.Enabled = true;
      }
      if (int.Parse(this.TotalPages.Text) > 0)
      {
        this.GridTitle1.Visible = true;
        this.DataGrid1.Visible = true;
        this.PagingLink.Visible = true;
    ...
    protected void NavigationLink_Click(object sender, CommandEventArgs e)
    {
      switch (e.CommandName)
      {
        case "First":
          ...
          break;
        case "Last":
          this._currentPageNumber = int.Parse(this.TotalPages.Text);
          break;
        case "Next":
          this._currentPageNumber = int.Parse(this.CurrentPage.Text) + 1;
          break;
        case "Prev":
          this._currentPageNumber = int.Parse(this.CurrentPage.Text) - 1;
          break;
    ...
    private void btRicerca_Click(object sender, EventArgs e) => this.Ricerca(true);
    ...
    public void LinkButton1_Click(object sender, CommandEventArgs e)
    {
      ...
      this.Server.Transfer("SfogliaRdlOdl_MP.aspx?FunId=" + (object) SfogliaRdlOdlPaging.FunId);
    }
    ...
    {
      this._myColl.AddControl(this.Page.Controls, ParentType.Page);
      this.Server.Transfer("CompletamentoMP.aspx?id_wo=" + e.CommandArgument + "&FunId=" + (object) SfogliaRdlOdlPaging.FunId);
    }
