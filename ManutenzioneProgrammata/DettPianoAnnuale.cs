...
// Type: TheSite.ManutenzioneProgrammata.DettPianoAnnuale
...
{
  public class DettPianoAnnuale : Page
  {
    ...
    public string DirectoryUp = (string) null;
    ...
    {
      DettPianoAnnuale.FunId = ((SiteModule) HttpContext.Current.Items[(object) "SiteModule"]).ModuleId;
      ...
      this.DescServ = this.Request.QueryString["descservizio"];
      ...
      this.lblpmp.Text = "Piano Manutenzione Programmata Anno: " + this.txtAnno.Text + " " + this.DescServ;
      this.GetDataGrid();
    ...
    private void DataGridRicerca_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
      if (e.Item.ItemType != ListItemType.Item && e.Item.ItemType != ListItemType.AlternatingItem)
        return;
      HtmlAnchor control = (HtmlAnchor) e.Item.Controls[1].Controls[1];
      if (this.e_Page == "ottimizza")
        control.HRef = "javascript:UpdateDettaglio('" + e.Item.Cells[0].Text + "','" + e.Item.Cells[2].Text + "','" + this.txtAnno.Text + "','" + this.txtID_BL.Text + "','" + e.Item.Cells[17].Text + "')";
      else
        control.HRef = "javascript:Dettaglio('" + e.Item.Cells[0].Text + "','" + e.Item.Cells[2].Text + "','" + this.txtAnno.Text + "')";
    ...
    private void cmdIndietro_Click(object sender, EventArgs e)
    {
      if (this.e_Page == "ottimizza")
        this.Server.Transfer("Schedula/OttimizzaPiano.aspx");
      else
        this.Server.Transfer("PianoAnnuale.aspx?FunId=" + (object) DettPianoAnnuale.FunId);
    }
  }
}
