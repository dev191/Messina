...
// Type: TheSite.ManutenzioneProgrammata.CreazioneODL_MP
...
{
  public class CreazioneODL_MP : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      CreazioneODL_MP.HelpLink = siteModule.HelpLink;
    ...
    {
      DataTable month = new CreaRDL().GetMonth(Convert.ToInt32(((ListControl) this.cmbsAnno).SelectedValue));
    ...
    private void BindComuni()
    {
      ...
      DataSet comuni = new CreaRDL().GetComuni(Convert.ToInt32(((ListControl) this.cmbsAnno).SelectedValue), ((ListControl) this.cmbMeseDa).SelectedValue, ((ListControl) this.cmbMeseA).SelectedValue);
    ...
    private void BindEdifici()
    {
      ...
      S_ControlsCollection controlsCollection = new S_ControlsCollection();
      DataSet edifici = new CreaRDL().GetEdifici(Convert.ToInt32(((ListControl) this.cmbsAnno).SelectedValue), Convert.ToInt32(((ListControl) this.cmbsComune).SelectedValue), ((ListControl) this.cmbMeseDa).SelectedValue, ((ListControl) this.cmbMeseA).SelectedValue);
    ...
    private void BindServizi()
    {
      ...
      S_ControlsCollection controlsCollection = new S_ControlsCollection();
      CreaRDL creaRdl = new CreaRDL();
      int.Parse(strArray[0]);
      DataSet servizi = creaRdl.GetServizi(Convert.ToInt32(((ListControl) this.cmbsAnno).SelectedValue), Convert.ToInt32(((ListControl) this.cmbsComune).SelectedValue), Convert.ToInt32(strArray[0]), ((ListControl) this.cmbMeseDa).SelectedValue, ((ListControl) this.cmbMeseA).SelectedValue);
    ...
    private S_ControlsCollection GetControl()
    {
      ...
      ((ParameterObject) sObject3).set_Value((object) int32);
      controlsCollection.Add(sObject3);
      int num3 = 0;
      if (((ListControl) this.cmbsServizio).SelectedValue != "0")
        num3 = int.Parse(((ListControl) this.cmbsServizio).SelectedValue);
      ...
      ((ParameterObject) sObject4).set_Value((object) num3);
      controlsCollection.Add(sObject4);
      int num4 = 0;
      if (((ListControl) this.cmbsAddetti).SelectedValue != "0")
        num4 = int.Parse(((ListControl) this.cmbsAddetti).SelectedValue);
      S_Object sObject5 = new S_Object();
      ((ParameterObject) sObject5).set_ParameterName("p_addetto");
      ...
      ((ParameterObject) sObject6).set_ParameterName("Mese1");
      ...
      ((ParameterObject) sObject6).set_Value((object) ((ListControl) this.cmbMeseDa).SelectedValue);
      controlsCollection.Add(sObject6);
      S_Object sObject7 = new S_Object();
      ((ParameterObject) sObject7).set_ParameterName("Mese2");
      ((ParameterObject) sObject7).set_DbType((CustomDBType) 2);
      ((ParameterObject) sObject7).set_Direction(ParameterDirection.Input);
      ((ParameterObject) sObject7).set_Index(7);
      ((ParameterObject) sObject7).set_Size(10);
      ((ParameterObject) sObject7).set_Value((object) ((ListControl) this.cmbMeseA).SelectedValue);
    ...
    private void Ricerca(bool reset)
    {
      ...
      CreaRDL creaRdl = new CreaRDL();
      DataSet dataSet = creaRdl.GetDataPaging(control1).Copy();
      if (reset)
      {
        S_ControlsCollection control2 = this.GetControl();
        this.GridTitle1.NumeroRecords = creaRdl.GetDataCount(control2).ToString();
      }
    ...
    private void SetDati()
    {
      ...
      foreach (DataGridItem dataGridItem in this.DataGridRicerca.Items)
      {
        ...
        if (control.Checked)
          hashtable.Add((object) num, (object) new OrdineLavoro()
          {
            bl_id = Convert.ToInt32(dataGridItem.Cells[2].Text),
            id_servizio = Convert.ToInt32(dataGridItem.Cells[5].Text),
            addetto_id = Convert.ToInt32(dataGridItem.Cells[7].Text),
            id = num
          });
      }
      this.Session.Remove("DatiList");
    ...
    private void SelezionaTutti(bool val)
    {
      if (!val)
      {
        ...
        this.SetControlli();
      DataSet dataSet = new CreaRDL().GetData(this.GetControl()).Copy();
    ...
    private void btnsCrea_Click(object sender, EventArgs e)
    {
      if (this.Session["DatiList"] != null)
      {
        ...
        try
        {
          creaRdl.beginTransaction();
          int num1 = 0;
          Hashtable hashtable = (Hashtable) this.Session["DatiList"];
          ...
          else
          {
            ...
            {
              OrdineLavoro ordineLavoro = (OrdineLavoro) enumerator.Value;
              S_ControlsCollection CollezioneControlli = new S_ControlsCollection();
              S_Object sObject1 = new S_Object();
              ((ParameterObject) sObject1).set_ParameterName("i_Edificio");
              ((ParameterObject) sObject1).set_DbType((CustomDBType) 1);
              ((ParameterObject) sObject1).set_Direction(ParameterDirection.Input);
              ((ParameterObject) sObject1).set_Index(0);
              ((ParameterObject) sObject1).set_Value((object) ordineLavoro.bl_id);
              CollezioneControlli.Add(sObject1);
              S_Object sObject2 = new S_Object();
              ((ParameterObject) sObject2).set_ParameterName("i_Category");
              ((ParameterObject) sObject2).set_DbType((CustomDBType) 1);
              ((ParameterObject) sObject2).set_Direction(ParameterDirection.Input);
              ((ParameterObject) sObject2).set_Index(1);
              ((ParameterObject) sObject2).set_Value((object) ordineLavoro.id_servizio);
              CollezioneControlli.Add(sObject2);
              S_Object sObject3 = new S_Object();
              ((ParameterObject) sObject3).set_ParameterName("i_ANNO");
              ((ParameterObject) sObject3).set_DbType((CustomDBType) 1);
              ((ParameterObject) sObject3).set_Direction(ParameterDirection.Input);
              ((ParameterObject) sObject3).set_Index(2);
              ((ParameterObject) sObject3).set_Value((object) Convert.ToInt32(((ListControl) this.cmbsAnno).SelectedValue));
              CollezioneControlli.Add(sObject3);
              S_Object sObject4 = new S_Object();
              ((ParameterObject) sObject4).set_ParameterName("i_MESE1");
              ((ParameterObject) sObject4).set_DbType((CustomDBType) 2);
              ((ParameterObject) sObject4).set_Direction(ParameterDirection.Input);
              ((ParameterObject) sObject4).set_Index(3);
              ((ParameterObject) sObject4).set_Size(10);
              ((ParameterObject) sObject4).set_Value((object) ((ListControl) this.cmbMeseDa).SelectedValue);
              CollezioneControlli.Add(sObject4);
              S_Object sObject5 = new S_Object();
              ((ParameterObject) sObject5).set_ParameterName("i_MESE2");
              ((ParameterObject) sObject5).set_DbType((CustomDBType) 2);
              ((ParameterObject) sObject5).set_Direction(ParameterDirection.Input);
              ((ParameterObject) sObject5).set_Index(4);
              ((ParameterObject) sObject5).set_Size(10);
              ((ParameterObject) sObject5).set_Value((object) ((ListControl) this.cmbMeseA).SelectedValue);
              CollezioneControlli.Add(sObject5);
              S_Object sObject6 = new S_Object();
              ((ParameterObject) sObject6).set_ParameterName("i_ADDETTO");
              ((ParameterObject) sObject6).set_DbType((CustomDBType) 1);
              ((ParameterObject) sObject6).set_Direction(ParameterDirection.Input);
              ((ParameterObject) sObject6).set_Index(5);
              ((ParameterObject) sObject6).set_Value((object) ordineLavoro.addetto_id);
              CollezioneControlli.Add(sObject6);
              int num2 = creaRdl.Add(CollezioneControlli);
              num1 += num2;
            }
            creaRdl.commitTransaction();
            this.Session.Remove("CheckedList");
            this.Session.Remove("DatiList");
            this.Session.Remove("DataSet");
            this.DataGridRicerca.CurrentPageIndex = 0;
            this.Resetta();
            this.Ricerca(true);
            SiteJavaScript.msgBox(this.Page, string.Format("SONO STATI INSERITI N. {0} Ordini di Lavoro.", (object) num1));
          }
        }
        catch (Exception ex)
        {
          Console.WriteLine(ex.Message);
          creaRdl.rollbackTransaction();
          string empty = string.Empty;
          SiteJavaScript.msgBox(this.Page, "Si è verificato un errore durante la creazione degli Ordini di Lavoro.");
        }
      }
      else
        SiteJavaScript.msgBox(this.Page, "Nessun Edificio selezionato.");
    ...
    private void cmbsAnno_SelectedIndexChanged(object sender, EventArgs e)
    {
      this.CaricaComboMesi();
      this.BindControls();
    }
    ...
    private void cmdReset_Click(object sender, EventArgs e) => this.Response.Redirect("CreazioneODL_MP.aspx");
  }
}
