...
// Type: TheSite.CommonPage.RiepilogoReperibilita1
...
{
  public class RiepilogoReperibilita1 : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      RiepilogoReperibilita1.FunId = siteModule.ModuleId;
    ...
    {
      this.MyDataGrid1.DataSource = (object) new Reperibilita().GetAllAddetti1().Tables[0];
