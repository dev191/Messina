...
// Type: TheSite.CommonPage.ListaFascicoli
...
{
  public class ListaFascicoli : Page
  {
    ...
    private void Execute()
    {
      ...
      ((ParameterObject) sObject).set_ParameterName("P_fascicolo");
      ...
      DataSet dataFascicoli = certificati.GetDataFascicoli(CollezioneControlli);
      this.DataGrid1.DataSource = (object) dataFascicoli;
      this.GridTitle1.NumeroRecords = dataFascicoli.Tables[0].Rows.Count == 0 ? "0" : dataFascicoli.Tables[0].Rows.Count.ToString();
    ...
    public string Valuta(object obj) => obj != DBNull.Value && obj.ToString() != "" ? obj.ToString().Replace("\\", "\\\\") : string.Empty;
