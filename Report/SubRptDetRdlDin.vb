...
Public Class SubRptDetRdlDin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.SubRptDetRdlDin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubRptDetRdlDin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRptDetRdlDin = New SubRptDetRdlDin()
        rpt.Site = Me.Site
        Return rpt
    End Function
