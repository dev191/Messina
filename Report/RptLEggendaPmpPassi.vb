...
Public Class RptLEggendaPmpPassi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptLEggendaPmpPassi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLEggendaPmpPassi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLEggendaPmpPassi = New RptLEggendaPmpPassi()
        rpt.Site = Me.Site
        Return rpt
    End Function
