...
Public Class RptTecnicoIntervento2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptTecnicoIntervento2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTecnicoIntervento2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTecnicoIntervento2 = New RptTecnicoIntervento2()
        rpt.Site = Me.Site
        Return rpt
    End Function
