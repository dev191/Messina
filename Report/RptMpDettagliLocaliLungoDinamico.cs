...
// Type: TheSite.Report.RptMpDettagliLocaliLungoDinamico
...
{
  public class RptMpDettagliLocaliLungoDinamico : ReportClass
  {
    public RptMpDettagliLocaliLungoDinamico() => base.\u002Ector();

    public virtual string ResourceName
    {
      get => "RptMpDettagliLocaliLungoDinamico.rpt";
      set
      {
      }
    }
