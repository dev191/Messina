...
Public Class RptMpDettagliLocaliCorto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptMpDettagliLocaliCorto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMpDettagliLocaliCorto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMpDettagliLocaliCorto = New RptMpDettagliLocaliCorto()
        rpt.Site = Me.Site
        Return rpt
    End Function
