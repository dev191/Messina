...
Public Class RptSpaziDistrMusure_V9
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptSpaziDistrMusure_V9.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSpaziDistrMusure_V9
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSpaziDistrMusure_V9 = New RptSpaziDistrMusure_V9()
        rpt.Site = Me.Site
        Return rpt
    End Function
