...
// Type: TheSite.Report.RptMpDettagliLocaliCorto
...
{
  public class RptMpDettagliLocaliCorto : ReportClass
  {
    public RptMpDettagliLocaliCorto() => base.\u002Ector();

    public virtual string ResourceName
    {
      get => "RptMpDettagliLocaliCorto.rpt";
      set
      {
      }
    }
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [Browsable(false)]
    public Section GroupHeaderSection1 => ((ReportDocument) this).get_ReportDefinition().get_Sections().get_Item(4);
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [Browsable(false)]
    public Section GroupFooterSection2 => ((ReportDocument) this).get_ReportDefinition().get_Sections().get_Item(7);
    ...
    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public Section GroupFooterSection3 => ((ReportDocument) this).get_ReportDefinition().get_Sections().get_Item(9);
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [Browsable(false)]
    public Section GroupFooterSection7 => ((ReportDocument) this).get_ReportDefinition().get_Sections().get_Item(11);

    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public Section Section4 => ((ReportDocument) this).get_ReportDefinition().get_Sections().get_Item(12);

    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [Browsable(false)]
    public Section PageFooterSection4 => ((ReportDocument) this).get_ReportDefinition().get_Sections().get_Item(13);
  }
}
