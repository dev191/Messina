...
Public Class SubRptPassi1C
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.SubRptPassi1C.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubRptPassi1C
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRptPassi1C = New SubRptPassi1C()
        rpt.Site = Me.Site
        Return rpt
    End Function
