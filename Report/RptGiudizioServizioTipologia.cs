...
// Type: TheSite.Report.RptGiudizioServizioTipologia
...
{
  public class RptGiudizioServizioTipologia : ReportClass
  {
    public RptGiudizioServizioTipologia() => base.\u002Ector();

    public virtual string ResourceName
    {
      get => "RptGiudizioServizioTipologia.rpt";
      set
      {
      }
    }
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [Browsable(false)]
    public Section Section8 => ((ReportDocument) this).get_ReportDefinition().get_Sections().get_Item(2);
