...
namespace TheSite.Report {
    ...
    public class RptMpDettagliLocaliLungo : ReportClass {
        ...
        public RptMpDettagliLocaliLungo() {
        }
        
        public override string ResourceName {
            get {
                return "RptMpDettagliLocaliLungo.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptMpDettagliLocaliLungo : Component, ICachedReport {
        ...
        public CachedRptMpDettagliLocaliLungo() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptMpDettagliLocaliLungo rpt = new RptMpDettagliLocaliLungo();
            rpt.Site = this.Site;
            return rpt;
        }
