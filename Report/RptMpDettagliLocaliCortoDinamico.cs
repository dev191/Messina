...
// Type: TheSite.Report.RptMpDettagliLocaliCortoDinamico
...
{
  public class RptMpDettagliLocaliCortoDinamico : ReportClass
  {
    public RptMpDettagliLocaliCortoDinamico() => base.\u002Ector();

    public virtual string ResourceName
    {
      get => "RptMpDettagliLocaliCortoDinamico.rpt";
      set
      {
      }
    }
