...
Public Class RptProgrammattaRdl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptProgrammattaRdl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptProgrammattaRdl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptProgrammattaRdl = New RptProgrammattaRdl()
        rpt.Site = Me.Site
        Return rpt
    End Function
