...
Public Class RptServizioMesi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptServizioMesi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptServizioMesi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptServizioMesi = New RptServizioMesi()
        rpt.Site = Me.Site
        Return rpt
    End Function
