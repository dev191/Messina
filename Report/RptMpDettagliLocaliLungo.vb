...
Public Class RptMpDettagliLocaliLungo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptMpDettagliLocaliLungo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMpDettagliLocaliLungo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMpDettagliLocaliLungo = New RptMpDettagliLocaliLungo()
        rpt.Site = Me.Site
        Return rpt
    End Function
