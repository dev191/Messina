...
Public Class RptChedeEq_V9
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptChedeEq_V9.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptChedeEq_V9
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptChedeEq_V9 = New RptChedeEq_V9()
        rpt.Site = Me.Site
        Return rpt
    End Function
