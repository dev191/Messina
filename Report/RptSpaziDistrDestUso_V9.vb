...
Public Class RptSpaziDistrDestUso_V9
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TheSite.RptSpaziDistrDestUso_V9.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSpaziDistrDestUso_V9
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSpaziDistrDestUso_V9 = New RptSpaziDistrDestUso_V9()
        rpt.Site = Me.Site
        Return rpt
    End Function
