...
namespace TheSite.Gestione
{
  public class Contab : Page
  {
    ...
    private EditContab _fp;

    private void Page_Load(object sender, EventArgs e)
    {
      SiteModule siteModule = (SiteModule) HttpContext.Current.Items[(object) "SiteModule"];
      ((HyperLink) this.GridTitle1.hplsNuovo).NavigateUrl = "../Gestione/EditContab.aspx?ItemID=0&FunId=" + (object) siteModule.ModuleId;
      ...
      Contab.FunId = siteModule.ModuleId;
      Contab.HelpLink = siteModule.HelpLink;
      this.PageTitle1.Title = siteModule.ModuleTitle;
      if (this.Page.IsPostBack || !(this.Context.Handler is EditContab))
        return;
      this._fp = (EditContab) this.Context.Handler;
      if (this._fp == null)
        return;
    ...
    private void Ricerca()
    {
      ...
      DataSet dataSet = contab.GetData(CollezioneControlli).Copy();
    ...
    private void BtnReset_Click(object sender, EventArgs e) => this.Response.Redirect("Contab.aspx?FunId=" + (object) Contab.FunId);
  }
}
