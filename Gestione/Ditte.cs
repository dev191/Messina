...
namespace TheSite.Gestione
{
  public class Ditte : Page
  {
    ...
    private EditDitte _fp;

    private void Page_Load(object sender, EventArgs e)
    {
      SiteModule siteModule = (SiteModule) HttpContext.Current.Items[(object) "SiteModule"];
      ((HyperLink) this.GridTitle1.hplsNuovo).NavigateUrl = "../Gestione/EditDitte.aspx?ItemID=0&FunId=" + (object) siteModule.ModuleId;
      ...
      Ditte.FunId = siteModule.ModuleId;
      Ditte.HelpLink = siteModule.HelpLink;
      this.PageTitle1.Title = siteModule.ModuleTitle;
      if (this.Page.IsPostBack || !(this.Context.Handler is EditDitte))
        return;
      this._fp = (EditDitte) this.Context.Handler;
      if (this._fp == null)
        return;
    ...
    private void Ricerca()
    {
      ...
      DataSet dataSet = ditte.GetData(CollezioneControlli).Copy();
    ...
    private void BtnReset_Click(object sender, EventArgs e) => this.Response.Redirect("Ditte.aspx?FunId=" + (object) Ditte.FunId);
  }
}
