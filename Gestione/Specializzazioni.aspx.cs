...
{	
	...
	/// </summary>
	public class Specializzazioni : System.Web.UI.Page    // System.Web.UI.Page
	{		
		...
		TheSite.Gestione.EditSpecializzazioni _fp;
		protected S_Controls.S_TextBox S_TextBox1;
		protected S_Controls.S_TextBox txtsServizio;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.GridTitle1.hplsNuovo.NavigateUrl = "../Gestione/EditSpecializzazioni.aspx?ItemID=0&FunId=" + _SiteModule.ModuleId;
			...
			if (!Page.IsPostBack)
			{
				if(Context.Handler is TheSite.Gestione.EditSpecializzazioni) 
				{	
				_fp = (TheSite.Gestione.EditSpecializzazioni) Context.Handler;
					if (_fp!=null)
					{
		...
		private void Ricerca()
		{
			...
			this.txtsServizio.DBDefaultValue = "%";
			S_ControlsCollection _SCollection = new S_ControlsCollection();
			_SCollection.AddItems(this.PanelRicerca.Controls);
			DataSet _MyDs = _Addetti.GetDataTR(_SCollection).Copy();
		...
		{
				Response.Redirect("Specializzazioni.aspx?FunId=" + FunId);
		}
	}
