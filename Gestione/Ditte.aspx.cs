...
namespace TheSite.Gestione
{
	...
	/// </summary>
	public class Ditte : System.Web.UI.Page    // System.Web.UI.Page
	{
		...
		{			
			...
			{	
				...
				if(Context.Handler is TheSite.Gestione.EditDitte) 
				{									
					_fp = (TheSite.Gestione.EditDitte) Context.Handler;
					if (_fp!=null)
					{
		...
		{
				Response.Redirect("Ditte.aspx?FunId=" + FunId);
		}
	}
}