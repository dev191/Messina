...
namespace TheSite.Gestione
{
	...
	public class Livelli : System.Web.UI.Page    // System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.GridTitle1.hplsNuovo.NavigateUrl = "../Gestione/EditLivelli.aspx?ItemID=0&FunId=" + _SiteModule.ModuleId;
			...
			if (!Page.IsPostBack)
			{	
				if(Context.Handler is TheSite.Gestione.EditLivelli) 
				{									
					_fp = (TheSite.Gestione.EditLivelli) Context.Handler;
					if (_fp!=null)
					{
		...
		private void Ricerca()
		{
			...
			DataSet _MyDs = _Livelli.GetData(_SCollection).Copy();
		...
		{
			Response.Redirect("Livelli.aspx?FunId=" + FunId);
		}
