...
namespace TheSite.Gestione
{
	...
	/// </summary>
	public class Reparti : System.Web.UI.Page    // System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.GridTitle1.hplsNuovo.NavigateUrl = "../Gestione/EditReparti.aspx?ItemID=0&FunId=" + _SiteModule.ModuleId;
			...
			if (!Page.IsPostBack)
			{	
				if(Context.Handler is TheSite.Gestione.EditReparti) 
				{									
					_fp = (TheSite.Gestione.EditReparti) Context.Handler;
					if (_fp!=null)
					{
		...
		private void Ricerca()
		{
			...
			DataSet _MyDs = _Reparti.GetData(_SCollection).Copy();
		...
		{
			Response.Redirect("Reparti.aspx?FunId=" + FunId);
		}
