...
namespace TheSite.Gestione
{
  public class Livelli : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      ((HyperLink) this.GridTitle1.hplsNuovo).NavigateUrl = "../Gestione/EditLivelli.aspx?ItemID=0&FunId=" + (object) siteModule.ModuleId;
      ...
      Livelli.FunId = siteModule.ModuleId;
      Livelli.HelpLink = siteModule.HelpLink;
      this.PageTitle1.Title = siteModule.ModuleTitle;
      if (this.Page.IsPostBack || !(this.Context.Handler is EditLivelli))
        return;
      this._fp = (EditLivelli) this.Context.Handler;
      if (this._fp == null)
        return;
    ...
    private void Ricerca()
    {
      ...
      DataSet dataSet = livelli.GetData(CollezioneControlli).Copy();
    ...
    private void BtnReset_Click(object sender, EventArgs e) => this.Response.Redirect("Livelli.aspx?FunId=" + (object) Livelli.FunId);
