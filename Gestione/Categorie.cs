...
// Type: TheSite.Gestione.Categorie
...
namespace TheSite.Gestione
{
  public class Categorie : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      ((HyperLink) this.GridTitle1.hplsNuovo).NavigateUrl = "../Gestione/EditCategorie.aspx?ItemID=0&FunId=" + (object) siteModule.ModuleId;
      ...
      Categorie.FunId = siteModule.ModuleId;
      Categorie.HelpLink = siteModule.HelpLink;
      this.PageTitle1.Title = siteModule.ModuleTitle;
      if (this.Page.IsPostBack || !(this.Context.Handler is EditCategorie))
        return;
      this._fp = (EditCategorie) this.Context.Handler;
      if (this._fp == null)
        return;
    ...
    {
      TheSite.Classi.ClassiAnagrafiche.Categorie categorie = new TheSite.Classi.ClassiAnagrafiche.Categorie();
      ...
      DataSet dataSet = categorie.GetData(CollezioneControlli).Copy();
    ...
    private void BtnReset_Click(object sender, EventArgs e) => this.Response.Redirect("Categorie.aspx?FunId=" + (object) Categorie.FunId);
