...
namespace TheSite.Gestione
{
  public class Settori : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      ((HyperLink) this.GridTitle1.hplsNuovo).NavigateUrl = "../Gestione/EditSettori.aspx?ItemID=0&FunId=" + (object) siteModule.ModuleId;
      ...
      Settori.FunId = siteModule.ModuleId;
      Settori.HelpLink = siteModule.HelpLink;
      this.PageTitle1.Title = siteModule.ModuleTitle;
      if (this.Page.IsPostBack || !(this.Context.Handler is EditSettori))
        return;
      this._fp = (EditSettori) this.Context.Handler;
      if (this._fp == null)
        return;
    ...
    private void Ricerca()
    {
      ...
      DataSet dataSet = settori.GetData(CollezioneControlli).Copy();
    ...
    private void BtnReset_Click(object sender, EventArgs e) => this.Response.Redirect("Settori.aspx?FunId=" + (object) Settori.FunId);
