...
namespace TheSite.Gestione
{
	...
	/// </summary>
	public class DestUso : System.Web.UI.Page    // System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.GridTitle1.hplsNuovo.NavigateUrl = "../Gestione/EditDestUso.aspx?ItemID=0&FunId=" + _SiteModule.ModuleId;
			...
			if (!Page.IsPostBack)
			{	
				if(Context.Handler is TheSite.Gestione.EditDestUso) 
				{									
					_fp = (TheSite.Gestione.EditDestUso) Context.Handler;
					if (_fp!=null)
					{
		...
		private void Ricerca()
		{
			...
			DataSet _MyDs =  _DestUso.GetData(_SCollection).Copy();
		...
		{
			Response.Redirect("DestUso.aspx?FunId=" + FunId);
		}
