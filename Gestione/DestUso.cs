...
namespace TheSite.Gestione
{
  public class DestUso : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      ((HyperLink) this.GridTitle1.hplsNuovo).NavigateUrl = "../Gestione/EditDestUso.aspx?ItemID=0&FunId=" + (object) siteModule.ModuleId;
      ...
      DestUso.FunId = siteModule.ModuleId;
      DestUso.HelpLink = siteModule.HelpLink;
      this.PageTitle1.Title = siteModule.ModuleTitle;
      if (this.Page.IsPostBack || !(this.Context.Handler is EditDestUso))
        return;
      this._fp = (EditDestUso) this.Context.Handler;
      if (this._fp == null)
        return;
    ...
    {
      TheSite.Classi.ClassiAnagrafiche.DestUso destUso = new TheSite.Classi.ClassiAnagrafiche.DestUso();
      ...
      DataSet dataSet = destUso.GetData(CollezioneControlli).Copy();
    ...
    private void BtnReset_Click(object sender, EventArgs e) => this.Response.Redirect("DestUso.aspx?FunId=" + (object) DestUso.FunId);
