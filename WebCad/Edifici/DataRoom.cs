...
using WebCad.Classi.ManOrdinaria;
  ...
  public class DataRoom : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      if (!this.IsPostBack)
      {
        ...
        {
          this._fp = (NavigazioneAppDEMO) this.Context.Handler;
          this.BindTuttiPiani();
          this.BindServizio("");
    ...
    public void imagebutton1_Click(object sender, CommandEventArgs e)
    {
      ...
      this.Server.Transfer("NavigazioneAppDEMO.aspx?var_stanza=" + str2 + "&var_bl_id=" + str1 + "&var_piani=" + str3 + "&TitoloStanza=" + str4 + "&FunId=" + (object) DataRoom.FunId);
    }
    ...
    public void imagebutton2_Click(object sender, CommandEventArgs e)
    {
      ...
      this._myColl.AddControl(this.Page.Controls, ParentType.Page);
      this.Server.Transfer("NavigazioneAppDEMO.aspx?var_piani=" + str2 + "&var_bl_id=" + str1 + "&TitoloPiano=" + str3);
    }
    ...
    private void Execute()
    {
      ...
      if (this.Ds.Tables[0].Rows.Count > 0)
      {
        ...
        this.GridTitle1.NumeroRecords = this.Ds.Tables[0].Rows.Count.ToString();
    ...
    private void BindServizio(string CodEdificio)
    {
      ...
      WebCad.Classi.ClassiDettaglio.Servizi servizi = new WebCad.Classi.ClassiDettaglio.Servizi(this.Context.User.Identity.Name);
      DataSet data;
      if (CodEdificio != "")
      {
        S_Object sObject1 = new S_Object();
