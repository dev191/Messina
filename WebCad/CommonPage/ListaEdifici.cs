...
// Type: WebCad.CommonPage.ListaEdifici
...
namespace WebCad.CommonPage
{
  public class ListaEdifici : Page
  {
    ...
    private void Execute()
    {
      ...
      DataSet data = new Navigazione().GetData(CollezioneControlli);
      this.MyDataGrid1.DataSource = (object) data;
      this.GridTitle1.NumeroRecords = data.Tables[0].Rows.Count == 0 ? "0" : data.Tables[0].Rows.Count.ToString();
