...
// Type: WebCad.UserControl.DatagridImageCoordTemplate
...
namespace WebCad.UserControl
{
  public class DatagridImageCoordTemplate : ITemplate
  {
    ...
    public DatagridImageCoordTemplate(
      ListItemType type,
      string testoColonna,
      string colname1,
      string colname2,
