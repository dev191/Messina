...
// Type: TheSite.Classi.ClassiAnagrafiche.Richiedenti
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class Richiedenti : AbstractBase
  {
    ...
    public DataSet CheckData(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RICHIEDENTI.SP_CHECKRICHIEDENTI";
      return oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
    }
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RICHIEDENTI.SP_GETSINGLERICHIEDENTI";
    ...
    public DataSet GetSingleData1(string p_cognome)
    {
      S_ControlsCollection controlsCollection = new S_ControlsCollection();
      S_Object sObject1 = new S_Object();
      ((ParameterObject) sObject1).set_ParameterName(nameof (p_cognome));
      ((ParameterObject) sObject1).set_DbType((CustomDBType) 2);
      ((ParameterObject) sObject1).set_Direction(ParameterDirection.Input);
      ((ParameterObject) sObject1).set_Index(0);
      ((ParameterObject) sObject1).set_Value((object) p_cognome);
      S_Object sObject2 = new S_Object();
      ((ParameterObject) sObject2).set_ParameterName("IO_CURSOR");
      ((ParameterObject) sObject2).set_DbType((CustomDBType) 8);
      ((ParameterObject) sObject2).set_Direction(ParameterDirection.Output);
      ...
      controlsCollection.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RICHIEDENTI.SP_GETSINGLERICHIEDENTI1";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_RICHIEDENTI.SP_EXECUTERICHIEDENTI");
    }
  }
}
