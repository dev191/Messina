...
// Type: TheSite.Classi.ClassiAnagrafiche.Eqstd
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class Eqstd : AbstractBase
  {
    public override DataSet GetData()
    {
      ...
      string str = "PACK_EQ_STD.SP_GETALLEQSTD";
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_EQ_STD.SP_GETEQSTD";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_EQ_STD.SP_GETSINGLEEQSTD";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_EQ_STD.SP_EXECUTEEQSTD");
    }
  }
}
