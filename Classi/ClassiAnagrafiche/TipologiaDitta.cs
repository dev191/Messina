...
// Type: TheSite.Classi.ClassiAnagrafiche.TipologiaDitta
...
{
  public class TipologiaDitta : AbstractBase
  {
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_DITTE.SP_GETTIPODITTAANAGRAFICA";
    ...
    public override DataSet GetData()
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_DITTE.SP_GETTIPODITTA";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_DITTE.SP_GETSINGLETIPOLOGIADITTA";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_DITTE.SP_EXECUTETIPOLOGIADITTA");
    }
  }
}
