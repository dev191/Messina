...
// Type: TheSite.Classi.ClassiAnagrafiche.DestUso
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class DestUso : AbstractBase
  {
    ...
    public override DataSet GetData()
    {
      ...
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_GETALLDESTUSO").Copy();
      return this._Ds;
    }
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_RPT_GESTIONE_SPAZI.SP_GETDESTUSO";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_GETSINGLEDESTUSO").Copy();
      this.Id = itemId;
      return this._Ds;
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_EXECUTEDESTUSO");
    }
  }
}
