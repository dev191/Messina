...
// Type: TheSite.Classi.ClassiAnagrafiche.Reparti
...
{
  public class Reparti : AbstractBase
  {
    private DataSet _Ds;
    ...
    public override DataSet GetData()
    {
      ...
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_GETALLREPARTI").Copy();
      return this._Ds;
    }
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_RPT_GESTIONE_SPAZI.SP_GETREPARTO";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_GETSINGLEREPARTO").Copy();
      this.Id = itemId;
      return this._Ds;
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_EXECUTEREPARTO");
    }
  }
}
