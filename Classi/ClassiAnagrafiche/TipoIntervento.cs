...
// Type: TheSite.Classi.ClassiAnagrafiche.TipoIntervento
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class TipoIntervento : AbstractBase
  {
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MS.SP_GETTIPOINTERVENTO";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MS.SP_GETSINGLETIPOINTERVENTO";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_MS.SP_EXECUTETIPOINERVENTO");
    }
  }
}
