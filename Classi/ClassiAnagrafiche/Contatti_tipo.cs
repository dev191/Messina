...
// Type: TheSite.Classi.ClassiAnagrafiche.Contatti_tipo
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class Contatti_tipo : AbstractBase
  {
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_RICHIEDENTI_TIPO.SP_GETCONTATTI_TIPO";
    ...
    public DataSet GetAllData()
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_CONTATTI_TIPO.SP_GETALLCONTATTI_TIPO";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_CONTATTI_TIPO.SP_GETSINGLECONTATTI_TIPO";
