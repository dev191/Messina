...
// Type: TheSite.Classi.ClassiAnagrafiche.TipoManutenzione
...
{
  public class TipoManutenzione : AbstractBase
  {
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_TIPOMANUTENZIONE.SP_GETMANUTENZIONEANAGRAFICA";
    ...
    public override DataSet GetData()
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_TIPOMANUTENZIONE.SP_GETALLMANUTENZIONE";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_TIPOMANUTENZIONE.SP_GETSINGLEMANUTENZIONE";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_TIPOMANUTENZIONE.SP_EXECUTEMATUTENZIONE");
    }
  }
}
