...
// Type: TheSite.Classi.ClassiAnagrafiche.Pmp
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class Pmp : AbstractBase
  {
    ...
    public DataSet GetAllTr()
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_SPECIALIZZAZIONI.SP_GETALLTR";
    ...
    public DataSet GetStdData(int itemId)
    {
      ...
      controlsCollection.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_PMP.SP_GETSINGLESTDDASERVIZIO";
      DataSet dataSet = oracleDataLayer.GetRows((object) controlsCollection, str).Copy();
      this.Id = itemId;
      return dataSet;
    }
    ...
    public DataSet GetSpecData(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_SPECIALIZZAZIONI.SP_SPEC_SERVIZIO";
      return oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
    }
    ...
    public string GetCodicepmp(S_ControlsCollection _SColl)
    {
      ...
      ((ParameterObject) sObject).set_DbType((CustomDBType) 8);
      ((ParameterObject) sObject).set_Direction(ParameterDirection.Output);
      ((ParameterObject) sObject).set_Index(((CollectionBase) _SColl).Count);
      _SColl.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_PMP.SP_CREAPMP";
      return oracleDataLayer.GetRows((object) _SColl, str).Copy().Tables[0].Rows[0][0].ToString();
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_PMP.SP_EXECUTEPMP");
    }
  }
}
