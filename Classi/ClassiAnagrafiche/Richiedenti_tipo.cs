...
// Type: TheSite.Classi.ClassiAnagrafiche.Richiedenti_tipo
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class Richiedenti_tipo : AbstractBase
  {
    ...
    public DataSet GetAllAddProg(string id_prog)
    {
      ...
      ((ParameterObject) sObject1).set_ParameterName("p_progetto");
      ((ParameterObject) sObject1).set_DbType((CustomDBType) 1);
      ((ParameterObject) sObject1).set_Direction(ParameterDirection.Input);
      ((ParameterObject) sObject1).set_Index(0);
      if (id_prog != "")
        ((ParameterObject) sObject1).set_Value((object) Convert.ToInt32(id_prog));
      else
