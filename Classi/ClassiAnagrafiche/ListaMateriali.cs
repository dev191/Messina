...
// Type: TheSite.Classi.ClassiAnagrafiche.ListaMateriali
...
{
  public class ListaMateriali : AbstractBase
  {
    public override DataSet GetData()
    {
      ...
      string str = "PACK_MATERIALI.SP_GETALLMATERIALI";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MATERIALI.SP_GETSINGLEMATERIALI";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_MATERIALI.SP_EXECUTEMATERIALI");
    }
  }
}
