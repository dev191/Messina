...
// Type: TheSite.Classi.ClassiAnagrafiche.PercentualiStraordinari
...
{
  public class PercentualiStraordinari : AbstractBase
  {
    private DataSet _Ds;
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_ADDETTI.SP_GETPERCENTUALISTRAORDINARI";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_ADDETTI.SP_GETSINGLEPERCENTUALISTRAORD").Copy();
      this.Id = itemId;
      return this._Ds;
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_ADDETTI.SP_EXECUTEPERCENTUALISTRAORD");
    }
  }
}
