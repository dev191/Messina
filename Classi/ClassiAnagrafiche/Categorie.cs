...
// Type: TheSite.Classi.ClassiAnagrafiche.Categorie
...
{
  public class Categorie : AbstractBase
  {
    private DataSet _Ds;
    ...
    public override DataSet GetData()
    {
      ...
      ((ParameterObject) sObject).set_Index(((CollectionBase) this.CollezioneControlli).Count + 1);
      this.CollezioneControlli.Add(sObject);
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_GETALLCATEGORIE").Copy();
      return this._Ds;
    }
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_RPT_GESTIONE_SPAZI.SP_GETCATEGORIA";
      this._Ds = oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
      return this._Ds;
    }
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      this.CollezioneControlli.Add(sObject1);
      this.CollezioneControlli.Add(sObject2);
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_GETSINGLECATEGORIA").Copy();
      this.Id = itemId;
      return this._Ds;
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_RPT_GESTIONE_SPAZI.SP_EXECUTECATEGORIA");
    }
  }
}
