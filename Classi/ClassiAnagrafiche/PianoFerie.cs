...
// Type: TheSite.Classi.ClassiAnagrafiche.PianoFerie
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class PianoFerie : AbstractBase
  {
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_PIANOFERIE.SP_GETPIANOFERIEUSER";
    ...
    public DataSet GetData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_PIANOFERIE.SP_GETPIANOFERIE";
      ...
      int itemId)
    {
      ...
      S_Object sObject1 = new S_Object();
      ((ParameterObject) sObject1).set_ParameterName("p_idPianoFerie");
      ((ParameterObject) sObject1).set_DbType((CustomDBType) 1);
      ((ParameterObject) sObject1).set_Direction(ParameterDirection.Input);
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_PIANOFERIE.SP_EXECUTEPIANOFERIE");
    }
  }
}
