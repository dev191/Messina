...
// Type: TheSite.Classi.ClassiAnagrafiche.Motivo_assenza
...
{
  public class Motivo_assenza : AbstractBase
  {
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_MOTIVOASSENZA.SP_GETMOTIVO_ASSENZA";
    ...
    public DataSet GetAllData()
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MOTIVOASSENZA.SP_GETALLMOTIVO_ASSENZA";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MOTIVOASSENZA.SP_GETSINGLEMOTIVO_ASSENZA";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_CONTATTI_TIPO.SP_EXECUTERICHIEDENTI_TIPO");
    }
  }
}
