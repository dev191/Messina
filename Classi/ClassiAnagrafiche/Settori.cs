...
// Type: TheSite.Classi.ClassiAnagrafiche.Settori
...
{
  public class Settori : AbstractBase
  {
    private DataSet _Ds;
    ...
    public override DataSet GetData()
    {
      ...
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_SERVIZI.SP_GETALLSETTORE").Copy();
      return this._Ds;
    }
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_SERVIZI.SP_GETSETTORE";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      this._Ds = new OracleDataLayer(this.s_ConnStr).GetRows((object) this.CollezioneControlli, "PACK_SERVIZI.SP_GETSINGLESETTORE").Copy();
      this.Id = itemId;
      return this._Ds;
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_SERVIZI.SP_EXECUTESETTORE");
    }
  }
}
