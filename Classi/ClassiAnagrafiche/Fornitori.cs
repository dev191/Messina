...
// Type: TheSite.Classi.ClassiAnagrafiche.Fornitori
...
namespace TheSite.Classi.ClassiAnagrafiche
{
  public class Fornitori : AbstractBase
  {
    ...
    public override DataSet GetData()
    {
      ...
      string str = "PACK_VN.SP_GETALLVN";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      ((ParameterObject) sObject1).set_ParameterName("p_id_vn");
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_VN.SP_GETSINGLEVN";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_VN.SP_EXECUTEVN");
    }
  }
}
