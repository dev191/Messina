...
namespace TheSite.Classi
{
  public class Menu : AbstractBase
  {
    ...
    public override DataSet GetData()
    {
      ...
      string str = "PACK_FUNZIONI_MENU.SP_GETALLFUNZIONI_MENU";
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_FUNZIONI_MENU.SP_GETFUNZIONI_MENU";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      ((ParameterObject) sObject1).set_ParameterName("p_Funzione_Menu_Id");
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_FUNZIONI_MENU.SP_GETSINGLEFUNZIONE_MENU";
    ...
    public DataSet GetDataMenuPadre()
    {
      ...
      controlsCollection.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_FUNZIONI_MENU.SP_GETALLFUNZIONI_MENUPADRE";
      return oracleDataLayer.GetRows((object) controlsCollection, str).Copy();
    }
    ...
    public DataSet GetInfoOrder(int itemParentId)
    {
      S_ControlsCollection controlsCollection = new S_ControlsCollection();
      S_Object sObject1 = new S_Object();
      ((ParameterObject) sObject1).set_ParameterName("p_Menu_Padre_Id");
      ((ParameterObject) sObject1).set_DbType((CustomDBType) 1);
      ((ParameterObject) sObject1).set_Direction(ParameterDirection.Input);
      ((ParameterObject) sObject1).set_Index(0);
      ((ParameterObject) sObject1).set_Value((object) itemParentId);
      S_Object sObject2 = new S_Object();
      ((ParameterObject) sObject2).set_ParameterName("IO_CURSOR");
      ((ParameterObject) sObject2).set_DbType((CustomDBType) 8);
      ((ParameterObject) sObject2).set_Direction(ParameterDirection.Output);
      ...
      controlsCollection.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_FUNZIONI_MENU.SP_GETINFOORDER_MENU";
      return oracleDataLayer.GetRows((object) controlsCollection, str).Copy();
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_FUNZIONI_MENU.SP_EXECUTEFUNZIONI_MENU");
    }
  }
}
