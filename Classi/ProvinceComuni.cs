...
// Type: TheSite.Classi.ProvinceComuni
...
namespace TheSite.Classi
{
  public class ProvinceComuni
  {
    ...
    public DataSet GetData()
    {
      ...
      string str = "PACK_COMMON.SP_GETPROVINCE";
    ...
    public DataSet GetComune(S_ControlsCollection CollezioneControlli)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_COMMON.SP_GETSINGLECOMUNI";
      this._Ds = oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
      return this._Ds;
    }

    public DataSet GetLocalizzazione(S_ControlsCollection CollezioneControlli)
    {
      S_Object sObject = new S_Object();
      ((ParameterObject) sObject).set_ParameterName("IO_CURSOR");
      ((ParameterObject) sObject).set_DbType((CustomDBType) 8);
      ...
      CollezioneControlli.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_COMMON.SP_GETLOCALIZZAZIONE";
      this._Ds = oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
      return this._Ds;
    }
    ...
    public DataSet GetFrazione(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_COMMON.SP_GETFRAZIONI";
      this._Ds = oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
      return this._Ds;
    }
  }
