...
// Type: TheSite.Classi.ManOrdinaria.RichiestaPaging
...
{
  public class RichiestaPaging : AbstractBase
  {
    public RichiestaPaging()
    {
    }

    public RichiestaPaging(int Id) => this.Id = Id;
    ...
    {
      if (((CollectionBase) CollezioneControlli).Count < 18)
      {
        S_Object sObject1 = new S_Object();
        ((ParameterObject) sObject1).set_ParameterName("p_utente");
        ((ParameterObject) sObject1).set_DbType((CustomDBType) 2);
