...
// Type: TheSite.Classi.ManOrdinaria.AggiornamentoRdl
...
namespace TheSite.Classi.ManOrdinaria
{
  public class AggiornamentoRdl : AbstractBase
  {
    ...
    public DataSet GetDateTime(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MAN_ORD.SP_GETCOMPORDINEORARIO";
      return oracleDataLayer.GetRows((object) controlsCollection, str).Copy();
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_GEST_RDL.SP_UPDATECOMPLETAMENTO");
    }
  }
}
