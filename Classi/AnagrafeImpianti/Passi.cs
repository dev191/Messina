...
// Type: TheSite.Classi.AnagrafeImpianti.Passi
...
namespace TheSite.Classi.AnagrafeImpianti
{
  public class Passi : AbstractBase
  {
    ...
    public Passi(string Username) => this.username = Username;
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_MAN_PROG.getProcStepsAllDett";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MAN_PROG.getProcStepsSingleDett";
