...
namespace TheSite.Classi
{
  public class Ruolo : AbstractBase
  {
    ...
    public override DataSet GetData()
    {
      ...
      string str = "PACK_RUOLI.SP_GETALLRUOLI";
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RUOLI.SP_GETRUOLI";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RUOLI.SP_GETSINGLERUOLO";
    ...
    public DataSet GetRuoliTranneMe(int itemId)
    {
      ...
      controlsCollection.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RUOLI.SP_GETRUOLIMENOME";
      DataSet dataSet = oracleDataLayer.GetRows((object) controlsCollection, str).Copy();
      this.Id = itemId;
      return dataSet;
    }
    ...
    public DataSet GetFunzioni(int itemId)
    {
      ...
      controlsCollection.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RUOLI.SP_FUNZIONI_RUOLO";
      DataSet dataSet = oracleDataLayer.GetRows((object) controlsCollection, str).Copy();
      this.Id = itemId;
      return dataSet;
    }
    ...
    public int UpdateFunzioni(S_ControlsCollection CollezioneControlli, ExecuteType Operazione)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_RUOLI.SP_EXECUTERUOLIFUNZIONI");
    }
    ...
    public int CopiaFunzioni(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject);
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_RUOLI.SP_COPIARUOLO");
    }
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_RUOLI.SP_EXECUTERUOLI");
    }
  }
}
