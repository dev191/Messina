...
// Type: TheSite.Classi.ManStraordinaria.ManCorrettivaPaging
...
namespace TheSite.Classi.ManStraordinaria
{
  public class ManCorrettivaPaging : AbstractBase
  {
    ...
    public ManCorrettivaPaging(int Id) => this.Id = Id;
    ...
    public DataSet GetSfogliaRDLExcel(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MAN_STRA.SP_GetSfogliaRDLExcel1";
      return oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
    }
    ...
    public DataSet GetSfogliaRDLExcel1(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MAN_STRA.SP_GetSfogliaRDLExcel2";
      return oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
    }
    ...
    public DataSet GetSfogliaRDLExcel2(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MAN_STRA.SP_GetSfogliaRDLExcel3";
      return oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
    }
    ...
    public DataSet GetSfogliaRDLPaging4(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MAN_STRA.SP_GetSfogliaRDL4";
      return oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
    }
    ...
    public int GetCount4(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject2);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_MAN_STRA.SP_GetSfogliaRDLCount4";
      return int.Parse(oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy().Tables[0].Rows[0][0].ToString());
    }
    ...
    public string UpdateStatusAut(int P_ID_STATO_AUTORIZ, int P_wr_id)
    {
      ...
      string commandText = "PACK_MANCORRETIVA.SP_UPD_WR_STAUTORIZ";
      using (OracleConnection connection = new OracleConnection(connectionString))
      {
        try
        {
          ...
          using (OracleCommand oracleCommand = new OracleCommand(commandText, connection))
          {
            ...
            oracleCommand.Parameters.Add(new OracleParameter(nameof (P_ID_STATO_AUTORIZ), OracleType.Number)
            {
              Value = (object) P_ID_STATO_AUTORIZ,
              Direction = ParameterDirection.Input
            });
            oracleCommand.Parameters.Add(new OracleParameter("p_CurrentUser", OracleType.VarChar, 50)
            {
              Value = (object) HttpContext.Current.User.Identity.Name,
              Direction = ParameterDirection.Input
            });
            oracleCommand.Parameters.Add(new OracleParameter(nameof (P_wr_id), OracleType.Number)
            {
              Value = (object) P_wr_id,
              Direction = ParameterDirection.Input
            });
            OracleParameter oracleParameter = new OracleParameter("MSG_OUT", OracleType.VarChar, 100);
            oracleParameter.Value = (object) "";
            oracleParameter.Direction = ParameterDirection.InputOutput;
            oracleCommand.Parameters.Add(oracleParameter);
            oracleCommand.ExecuteNonQuery();
            str = oracleParameter.Value.ToString();
          }
        }
        finally
        {
