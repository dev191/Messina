...
// Type: TheSite.Classi.ClassiDettaglio.SchedaApparecchiatura
...
namespace TheSite.Classi.ClassiDettaglio
{
  public class SchedaApparecchiatura : AbstractBase
  {
    ...
    public SchedaApparecchiatura(string Username) => this.s_username = Username;

    public override DataSet GetData()
    {
      S_ControlsCollection controlsCollection = new S_ControlsCollection();
      S_Object sObject1 = new S_Object();
      ((ParameterObject) sObject1).set_ParameterName("p_eq_std");
      ...
      string str = "PACK_SCHEDAAPPARECCHIATURE.SP_GETSCHEDAAPPARECCHIATURE";
