...
// Type: TheSite.Classi.ClassiDettaglio.UnitaMisura
...
namespace TheSite.Classi.ClassiDettaglio
{
  public class UnitaMisura : AbstractBase
  {
    ...
    public UnitaMisura(string UserName) => this.UserName = UserName;
    ...
    public override DataSet GetData()
    {
      ...
      string str = "PACK_MATERIALI.SP_GETALLMISURA";
