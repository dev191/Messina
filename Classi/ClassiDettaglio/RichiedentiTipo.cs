...
// Type: TheSite.Classi.ClassiDettaglio.RichiedentiTipo
...
{
  public class RichiedentiTipo : AbstractBase
  {
    private string s_Descrizione = string.Empty;

    public RichiedentiTipo()
    {
    }

    public RichiedentiTipo(int Id)
      : this(Id, string.Empty)
    {
    }

    public RichiedentiTipo(int Id, string Descrizione)
    {
      this.Id = Id;
    ...
    public override DataSet GetData()
    {
      ...
      string str = "PACK_RICHIEDENTI_TIPO.SP_GETALLRICHIEDENTI_TIPO";
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RICHIEDENTI_TIPO.SP_GETRICHIEDENTI_TIPO";
    ...
    public override DataSet GetSingleData(int itemId)
    {
      ...
      ((ParameterObject) sObject1).set_ParameterName("p_Richiedenti_Tipo_Id");
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_RICHIEDENTI_TIPO.SP_GETSINGLERICHIEDENTI_TIPO";
      ...
      int itemId)
    {
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_RICHIEDENTI_TIPO.SP_EXECUTERICHIEDENTI_TIPO");
    }
  }
}
