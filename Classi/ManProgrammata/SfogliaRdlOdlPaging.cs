...
// Type: TheSite.Classi.ManProgrammata.SfogliaRdlOdlPaging
...
{
  public class SfogliaRdlOdlPaging : AbstractBase
  {
    private string username = string.Empty;

    public SfogliaRdlOdlPaging(string UserName) => this.username = UserName;
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      string str = "PACK_ORDINARIA_SFOGLIA.SP_GETRDLODL3";
    ...
    protected override int ExecuteUpdate(
      ...
      int itemId)
    {
      ((CollectionBase) CollezioneControlli).RemoveAt(16);
      ((CollectionBase) CollezioneControlli).RemoveAt(15);
      ((CollectionBase) CollezioneControlli).RemoveAt(14);
      S_Object sObject = new S_Object();
      ((ParameterObject) sObject).set_ParameterName("IO_CURSOR");
      ((ParameterObject) sObject).set_DbType((CustomDBType) 8);
      ((ParameterObject) sObject).set_Direction(ParameterDirection.Output);
      ...
      CollezioneControlli.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_ORDINARIA_SFOGLIA.SP_GETRDLODL3Count";
