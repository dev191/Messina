...
// Type: TheSite.Classi.ManProgrammata.CreaRDL
...
namespace TheSite.Classi.ManProgrammata
{
  public class CreaRDL : AbstractBase
  {
    ...
    public CreaRDL() => this._OraDl = new OracleDataLayer(this.s_ConnStr);
    ...
    public DataTable GetMonth(int anno)
    {
      ...
      string str = "PACK_SCHEDULA.Crea_WO_Getmesi";
    ...
    public DataSet GetComuni(int anno, string MeseDa, string MeseA)
    {
      ...
      string str = "PACK_SCHEDULA.Crea_WO_GetComuni";
    ...
    public DataSet GetEdifici(int anno, int id_comune, string Mese1, string Mese2)
    {
      ...
      string str = "PACK_SCHEDULA.Crea_WO_GetEdifici";
      return this._OraDl.GetRows((object) controlsCollection, str).Copy();
    }
      ...
      string Mese2)
    {
      ...
      controlsCollection.Add(sObject6);
      string str = "PACK_SCHEDULA.Crea_WO_GetServizi";
      return this._OraDl.GetRows((object) controlsCollection, str).Copy();
    }
      ...
      string Mese2)
    {
      ...
      string str = "PACK_SCHEDULA.Crea_WO_GetAddetti";
      return this._OraDl.GetRows((object) controlsCollection, str).Copy();
    }
    ...
    public override DataSet GetData(S_ControlsCollection CollezioneControlli)
    {
      ...
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_SCHEDULA.Crea_WO_Ricerca";
    ...
    public DataSet GetDataPaging(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_SCHEDULA.Crea_WO_RicercaPaging";
      return oracleDataLayer.GetRows((object) CollezioneControlli, str).Copy();
    }
    ...
    public int GetDataCount(S_ControlsCollection CollezioneControlli)
    {
      ...
      CollezioneControlli.Add(sObject);
      OracleDataLayer oracleDataLayer = new OracleDataLayer(this.s_ConnStr);
      string str = "PACK_SCHEDULA.Crea_WO_RicercaCount";
      ...
      int itemId)
    {
      if (Operazione != ExecuteType.Insert)
        return 0;
      S_Object sObject1 = new S_Object();
      ((ParameterObject) sObject1).set_ParameterName("f_num_addetti");
      ((ParameterObject) sObject1).set_DbType((CustomDBType) 1);
      ...
      S_Object sObject2 = new S_Object();
      ((ParameterObject) sObject2).set_ParameterName("f_MsgDB");
      ((ParameterObject) sObject2).set_DbType((CustomDBType) 2);
      ((ParameterObject) sObject2).set_Direction(ParameterDirection.Output);
      ((ParameterObject) sObject2).set_Index(((CollectionBase) CollezioneControlli).Count + 1);
      ((ParameterObject) sObject2).set_Size(1000);
      CollezioneControlli.Add(sObject2);
      S_Object sObject3 = new S_Object();
      ((ParameterObject) sObject3).set_ParameterName("f_tot_OdL");
      ((ParameterObject) sObject3).set_DbType((CustomDBType) 1);
      ...
      return new OracleDataLayer(this.s_ConnStr).GetRowsAffected((object) CollezioneControlli, "PACK_SCHEDULA.Crea_WO");
    }
  }
}
