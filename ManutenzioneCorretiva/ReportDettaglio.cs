...
// Type: TheSite.ManutenzioneCorretiva.ReportDettaglio
...
{
  public class ReportDettaglio : Page
  {
    ...
    protected HtmlTableCell tdDetServizio;
    protected HtmlTableCell tdIntServizio;
    protected HtmlTableCell tdDetDescrizione;
    protected HtmlTableCell tdIntDescrizione;
    protected HtmlTableCell tdTotale;
    ...
    private void Execute()
    {
      ...
      DataSet datiDettaglio = report.GetDatiDettaglio((int) short.Parse(this.tipointervento_id), (int) short.Parse(this.anno), "Consuntivo");
      if (datiDettaglio.Tables[0].Rows.Count > 0)
      {
        this.TblMessaggio.Visible = false;
        this.repeater1.DataSource = (object) datiDettaglio;
        this.repeater1.DataBind();
        this.repeater2.DataSource = (object) report.GetDatiTotaliDettaglio((int) short.Parse(this.tipointervento_id), (int) short.Parse(this.anno), "Consuntivo");
