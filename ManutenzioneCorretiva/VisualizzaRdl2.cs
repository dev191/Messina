...
// Type: TheSite.ManutenzioneCorretiva.VisualizzaRdl2
...
{
  public class VisualizzaRdl2 : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      if (this.Request.Params["ItemId"] != null)
      {
        ...
        if (this.Context.User.IsInRole("callcenter") || this.Context.User.IsInRole("TecnicoPapardo"))
        {
          this.BtSalvaSGA.Visible = false;
          ((Control) this.cmdApprova).Visible = false;
        }
        ...
        if (row["DescTipoIntervento"] != DBNull.Value)
          this.lblTipoIntervento.Text = row["tipomanut"].ToString();
    ...
    private void btnsNuova_Click(object sender, EventArgs e)
    {
      ...
      this.Response.Redirect("CreazioneSGA2.aspx?FunId=" + (object) this.FunId + str);
    }
    ...
    private void btnModificaRDL_Click(object sender, EventArgs e)
    {
      ...
      if (this.Request["VarApp"] != null)
        str = "&VarApp=" + this.Request["VarApp"];
      this.Response.Redirect("CreazioneSGA2.aspx?ItemId=" + this.txtWrHidden.Text + str);
    }
