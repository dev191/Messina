...
// Type: TheSite.ManutenzioneCorretiva.VisualizzaRdl1
...
{
  public class VisualizzaRdl1 : Page
  {
    ...
    private void btnsNuova_Click(object sender, EventArgs e)
    {
      ...
      this.Response.Redirect("CreazioneSGA1.aspx?FunId=" + (object) this.FunId + str);
    }
    ...
    private void btnModificaRDL_Click(object sender, EventArgs e)
    {
      ...
      if (this.Request["VarApp"] != null)
        str = "&VarApp=" + this.Request["VarApp"];
      this.Response.Redirect("CreazioneSGA1.aspx?ItemId=" + this.txtWrHidden.Text + str);
    }
