...
// Type: TheSite.WebControls.VisualizzaSolleciti
...
{
  public class VisualizzaSolleciti : UserControl
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      this.btsCodice.Attributes.Add("onclick", "ShowFrameVisSoll('" + this.idTextCod + "'," + ("'prj=" + this.Progetto + "&idric'") + ",event);");
      SiteJavaScript.ShowFrameVisSollecito(this.Page, 1);
