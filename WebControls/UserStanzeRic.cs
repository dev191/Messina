...
// Type: TheSite.WebControls.UserStanzeRic
...
{
  public class UserStanzeRic : UserControl
  {
    ...
    private void ShowFramest(int NumDirectory)
    {
      ...
      stringBuilder.Append("document.getElementById(\"docstanza\").src=\"" + str + "CommonPage/ListaStanzeRic.aspx?codstanza=\" + ctrl2 + idUsercontrol1;\n");
      stringBuilder.Append("}\n");
