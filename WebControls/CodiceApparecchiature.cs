...
// Type: TheSite.WebControls.CodiceApparecchiature
...
namespace TheSite.WebControls
{
  public class CodiceApparecchiature : UserControl
  {
    ...
    protected TextBox RichiestaLettura;
    protected S_TextBox TxtIdApp;
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      if (!(this.NameComboApparecchiature != ""))
        return;
      string script = "<script language=JavaScript> var idthis='" + this.ClientID + "'\n" + "var std='" + this.Page.FindControl(this.NameComboApparecchiature).ClientID + "'" + "<" + "/" + "script>";
      if (!this.Page.IsClientScriptBlockRegistered("clientScript2"))
        this.Page.RegisterClientScriptBlock("clientScript2", script);
    ...
    private void ShowFrame2(int NumDirectory)
    {
      ...
      stringBuilder.Append("var lettura=\"&lettura=\" + document.getElementById(\"" + this.RichiestaLettura.ClientID + "\").value;\n");
      ...
      stringBuilder.Append("document.getElementById(\"docapp\").src=\"" + str + "CommonPage/ListaApparecchiature.aspx?codapp=\" + ctrl2 + idUsercontrol+ lettura;\n");
      stringBuilder.Append("}\n");
    ...
    public string s_RichiestaLettura
    {
      set => this.RichiestaLettura.Text = value;
    }
    ...
    public string IdApparecchiatura
    {
      get => ((TextBox) this.TxtIdApp).Text.Length > 0 ? ((TextBox) this.TxtIdApp).Text : string.Empty;
      set => ((TextBox) this.TxtIdApp).Text = value;
    }
