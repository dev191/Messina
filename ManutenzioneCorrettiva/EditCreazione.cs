...
// Type: TheSite.ManutenzioneCorrettiva.EditCreazione
...
{
  public class EditCreazione : Page
  {
    ...
    {
      this._SiteModule = new SiteModule("./ManutenzioneCorrettiva/EditCreazione.aspx");
