...
// Type: TheSite.ManutenzioneCorrettiva.EditCompletamento
...
{
  public class EditCompletamento : Page
  {
    ...
    {
      this._SiteModule = new SiteModule("./ManutenzioneCorrettiva/EditCompletamento.aspx");
