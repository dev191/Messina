...
// Type: TheSite.ManutenzioneCorrettiva.CompletaRdl
...
namespace TheSite.ManutenzioneCorrettiva
{
  public class CompletaRdl : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      this._SiteModule = new SiteModule("./ManutenzioneCorrettiva/CompletaRdl.aspx");
      ...
      this._ClManCorrettiva.TotManodopera(this.wr_id);
      if (!this.IsPostBack)
      {
      ...
      if (!((Control) this.Datapanel5).Visible)
        return;
      this.Page.RegisterStartupScript("sum", "<script language='javascript'>somma();</script>");
    }
    ...
    private bool CreaPiano(int itemId)
    {
      ...
      if (dataSet.Tables[0].Rows.Count == 1)
      {
        ...
        long num2 = CompletaRdl.DateAndTime.DateDiff(CompletaRdl.DateInterval.Month, dt1, dt2);
    ...
    private void SetVisisbleCompletata()
    {
      ...
      this.BtInviaPreventivo.Enabled = true;
      ((Control) this.Datapanel5).Visible = true;
    ...
    private void LoadDati()
    {
      ...
      DataSet singleRdlNew1 = this._ClManCorrettiva.GetSingleRdlNew1(this.wr_id);
      if (singleRdlNew1.Tables[0].Rows.Count == 0)
        return;
      DataRow row1 = singleRdlNew1.Tables[0].Rows[0];
      ...
      if (row1["DIE_DICHIARA1"] != DBNull.Value)
        this.Ck1.Checked = int.Parse(row1["DIE_DICHIARA1"].ToString()) == 1;
      if (row1["DIE_DICHIARA2"] != DBNull.Value)
        this.Ck2.Checked = int.Parse(row1["DIE_DICHIARA2"].ToString()) == 1;
    ...
    private void InitializeComponent()
    {
      ...
      this.BtInviaCons.Click += new EventHandler(this.BtInviaCons_Click);
      this.btImgDeleteCons.Click += new ImageClickEventHandler(this.btImgDeleteCons_Click);
    ...
    private void SaveDocument(string filename, string dimesione, string tipodoc)
    {
      ...
      this._ClManCorrettiva.ExecuteUpdateDOC1(CollezioneControlli);
    }
    ...
    private S_ControlsCollection GetParamEmissione(S_ControlsCollection _SColl)
    {
      ...
      _SColl.Add(sObject6);
      S_Object sObject7 = new S_Object();
      ((ParameterObject) sObject7).set_ParameterName("p_numeropreventivo");
      ((ParameterObject) sObject7).set_DbType((CustomDBType) 2);
      ((ParameterObject) sObject7).set_Direction(ParameterDirection.Input);
      ((ParameterObject) sObject7).set_Index(((CollectionBase) _SColl).Count);
      ((ParameterObject) sObject7).set_Size(20);
      ((ParameterObject) sObject7).set_Value((object) this.TxtNumPreventivo.Text);
      _SColl.Add(sObject7);
      S_Object sObject8 = new S_Object();
      ((ParameterObject) sObject8).set_ParameterName("p_importopreventivo");
      ((ParameterObject) sObject8).set_DbType((CustomDBType) 4);
      ((ParameterObject) sObject8).set_Direction(ParameterDirection.Input);
      ((ParameterObject) sObject8).set_Index(((CollectionBase) _SColl).Count);
      if (((TextBox) this.txtImpPrev1).Text == "")
        ((ParameterObject) sObject8).set_Value((object) 0);
      else
        ((ParameterObject) sObject8).set_Value((object) double.Parse(((TextBox) this.txtImpPrev1).Text + "," + ((TextBox) this.txtImpPrev2).Text));
      _SColl.Add(sObject8);
      return _SColl;
    }
    ...
    private void btApprova_Click(object sender, EventArgs e)
    {
      ...
      this._ClManCorrettiva.ExecuteUpdateSGA1(paramEmissione);
      this.SaveDocumentPreventivo();
      this.LoadDati();
    }
    ...
    private void SaveCompletamento()
    {
      ...
      ((ParameterObject) sObject4).set_Size(256);
      ...
      ((ParameterObject) sObject10).set_Value((object) (this.Ck1.Checked ? 1 : 0));
      ...
      ((ParameterObject) sObject11).set_Value((object) (this.Ck2.Checked ? 1 : 0));
      ...
      if (((TextBox) this.ImpCons1).Text == "")
        ...
        ((ParameterObject) sObject15).set_Value((object) double.Parse(((TextBox) this.ImpCons1).Text + "," + ((TextBox) this.ImpCons2).Text));
      ...
      this._ClManCorrettiva.ExecuteUpdateCompletamentoNew1(paramEmissione);
    }
    ...
    private void SaveDocumentPreventivo()
    {
      ...
      if (this.FilePreventivo.PostedFile != null && this.FilePreventivo.PostedFile.FileName != "")
      {
        ...
        string str2 = Path.Combine(this.Server.MapPath("../Doc_DB"), "Correttiva");
        if (!Directory.Exists(str2))
          Directory.CreateDirectory(str2);
    ...
    private void SaveDocumentPreventivo(string filename)
    {
      ...
      CollezioneControlli.Add(sObject5);
      this._ClManCorrettiva.ExecuteUpdatePreventivo1(CollezioneControlli);
    }
    ...
    private void LoadDocumentPrev()
    {
      this.LkPrev.Visible = false;
      this.btImgDelete.Visible = false;
      DataSet documentazionePrev1 = this._ClManCorrettiva.GetDocumentazionePrev1(this.wr_id);
      if (documentazionePrev1.Tables[0].Rows.Count == 0)
      {
        this.LkPrev.Visible = false;
        this.btImgDelete.Visible = false;
      }
      ...
      {
        if (documentazionePrev1.Tables[0].Rows[0]["nome_doc"] == DBNull.Value)
          return;
        this.LkPrev.Visible = true;
        this.btImgDelete.Visible = true;
        this.LkPrev.Text = documentazionePrev1.Tables[0].Rows[0]["nome_doc"].ToString();
        this.btImgDelete.CommandArgument = documentazionePrev1.Tables[0].Rows[0]["id_file"].ToString();
        this.LkPrev.NavigateUrl = "../Doc_DB/Correttiva/" + this.wr_id.ToString() + "/PREV/" + documentazionePrev1.Tables[0].Rows[0]["nome_doc"].ToString();
      }
    }
    ...
    private void btImgDelete_Click(object sender, ImageClickEventArgs e)
    {
      ...
      else
      {
        ...
        File.Delete(Path.Combine(Path.Combine(Path.Combine(this.Server.MapPath("../Doc_DB"), "Correttiva"), this.wr_id.ToString()), "PREV/" + this.LkPrev.Text));
        this.LkPrev.Visible = false;
        this.btImgDelete.Visible = false;
      }
    }

    private void BtInviaCons_Click(object sender, EventArgs e) => this.SaveDocumentConsuntivo();
    ...
    private void SaveDocumentConsuntivo(string filename)
    {
      ...
      CollezioneControlli.Add(sObject4);
      this._ClManCorrettiva.ExecuteUpdateConsuntivo1(CollezioneControlli);
    }

    private void LoadDocumentCons()
    {
      DataSet documentazioneCons1 = this._ClManCorrettiva.GetDocumentazioneCons1(this.wr_id);
      if (documentazioneCons1.Tables[0].Rows.Count == 0)
      {
        this.LkCons.Visible = false;
        this.btImgDeleteCons.Visible = false;
      }
      ...
      {
        if (documentazioneCons1.Tables[0].Rows[0]["nome_doc"] == DBNull.Value)
          return;
        this.LkCons.Visible = true;
        this.btImgDeleteCons.Visible = true;
        this.LkCons.Text = documentazioneCons1.Tables[0].Rows[0]["nome_doc"].ToString();
        this.btImgDeleteCons.CommandArgument = documentazioneCons1.Tables[0].Rows[0]["id_file"].ToString();
        this.LkCons.NavigateUrl = "../Doc_DB/Correttiva/" + this.wr_id.ToString() + "/CONS/" + documentazioneCons1.Tables[0].Rows[0]["nome_doc"].ToString();
      }
    }
    ...
    private void btImgDeleteCons_Click(object sender, ImageClickEventArgs e)
    {
      ...
      else
      {
        ...
        CollezioneControlli.Add(sObject2);
        this._ClManCorrettiva.ExecuteUpdateConsuntivo1(CollezioneControlli);
        File.Delete(Path.Combine(Path.Combine(Path.Combine(this.Server.MapPath("../Doc_DB"), "Correttiva"), this.wr_id.ToString()), "CONS/" + this.LkCons.Text));
        this.LkCons.Visible = false;
        this.btImgDeleteCons.Visible = false;
      }
    }
    ...
    {
      public static long DateDiff(CompletaRdl.DateInterval interval, DateTime dt1, DateTime dt2) => CompletaRdl.DateAndTime.DateDiff(interval, dt1, dt2, DateTimeFormatInfo.CurrentInfo.FirstDayOfWeek);
      ...
      public static long DateDiff(
        CompletaRdl.DateInterval interval,
        DateTime dt1,
        DateTime dt2,
        DayOfWeek eFirstDayOfWeek)
      {
        if (interval == CompletaRdl.DateInterval.Year)
          return (long) (dt2.Year - dt1.Year);
        if (interval == CompletaRdl.DateInterval.Month)
          return (long) Math.Abs(12 * (dt1.Year - dt2.Year) + dt1.Month - dt2.Month);
        TimeSpan timeSpan = dt2 - dt1;
        if (interval == CompletaRdl.DateInterval.Day || interval == CompletaRdl.DateInterval.DayOfYear)
          return CompletaRdl.DateAndTime.Round(timeSpan.TotalDays);
        switch (interval)
        {
          case CompletaRdl.DateInterval.Hour:
            return CompletaRdl.DateAndTime.Round(timeSpan.TotalHours);
          case CompletaRdl.DateInterval.Minute:
            return CompletaRdl.DateAndTime.Round(timeSpan.TotalMinutes);
          case CompletaRdl.DateInterval.Quarter:
            double quarter = (double) CompletaRdl.DateAndTime.GetQuarter(dt1.Month);
            return CompletaRdl.DateAndTime.Round((double) CompletaRdl.DateAndTime.GetQuarter(dt2.Month) - quarter + (double) (4 * (dt2.Year - dt1.Year)));
          case CompletaRdl.DateInterval.Second:
            return CompletaRdl.DateAndTime.Round(timeSpan.TotalSeconds);
          case CompletaRdl.DateInterval.Weekday:
            return CompletaRdl.DateAndTime.Round(timeSpan.TotalDays / 7.0);
          case CompletaRdl.DateInterval.WeekOfYear:
            while (dt2.DayOfWeek != eFirstDayOfWeek)
              dt2 = dt2.AddDays(-1.0);
            while (dt1.DayOfWeek != eFirstDayOfWeek)
              dt1 = dt1.AddDays(-1.0);
            return CompletaRdl.DateAndTime.Round((dt2 - dt1).TotalDays / 7.0);
          default:
            return 0;
        }
      }
