...
// Type: TheSite.ManutenzioneCorrettiva.SfogliaRdlPaging5
...
{
  public class SfogliaRdlPaging5 : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      SfogliaRdlPaging5.FunId = this._SiteModule.ModuleId;
      SfogliaRdlPaging5.HelpLink = this._SiteModule.HelpLink;
    ...
    private void cmdExcel_Click(object sender, EventArgs e)
    {
      ...
      DataTable dataTable2 = !(((ListControl) this.cmbsTipoManutenzione).SelectedValue == "3") ? this.GetWordExcel().Tables[0].Copy() : new ManCorrettivaPaging().GetSfogliaRDLExcel2(this.GetData()).Copy().Tables[0].Copy();
