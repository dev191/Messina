...
// Type: TheSite.ManutenzioneCorrettiva.ApprovaRDL1
...
namespace TheSite.ManutenzioneCorrettiva
{
  public class ApprovaRDL1 : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      this._SiteModule = new SiteModule("./ManutenzioneCorrettiva/ApprovaRdl1.aspx");
    ...
    private void cmdReset_Click(object sender, EventArgs e)
    {
      ...
      if (this.Request["VarApp"] != null)
        str = "&VarApp=" + this.Request["VarApp"];
      this.Response.Redirect("ApprovaRDL1.aspx?Fun=" + this.ViewState["FunId"] + str);
    }
  }
}
