...
// Type: TheSite.ManutenzioneCorrettiva.SfogliaRdlPaging
...
{
  public class SfogliaRdlPaging : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      SfogliaRdlPaging.FunId = this._SiteModule.ModuleId;
      SfogliaRdlPaging.HelpLink = this._SiteModule.HelpLink;
    ...
    private void DataGridRicerca_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
      ...
      if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
      {
        ...
        {
          control4.HRef = "javascript:openpdf('" + dataItem["WR_ID"].ToString() + "','PREV','" + dataItem["pdfpreventivo"].ToString().Replace("'", "`") + "');";
        ...
        {
          control5.HRef = "javascript:openpdf('" + dataItem["WR_ID"].ToString() + "','CONS','" + dataItem["pdfconsuntivo"].ToString().Replace("'", "`") + "');";
