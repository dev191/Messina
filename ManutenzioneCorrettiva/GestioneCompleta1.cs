...
// Type: TheSite.ManutenzioneCorrettiva.GestioneCompleta1
...
{
  public class GestioneCompleta1 : Page
  {
    ...
    {
      this._SiteModule = new SiteModule("./ManutenzioneCorrettiva/GestioneCompleta1.aspx");
      this.IsEditable = this._SiteModule.IsEditable;
      this.DataGrid1.Columns[0].Visible = this.IsEditable;
      GestioneCompleta1.HelpLink = this._SiteModule.HelpLink;
    ...
    private void S_Btreset_Click(object sender, EventArgs e)
    {
      ...
      this.Response.Redirect("GestioneCompleta1.aspx?FunId=" + this.ViewState["FunId"] + str);
    }
