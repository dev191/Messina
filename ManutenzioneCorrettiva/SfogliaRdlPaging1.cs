...
// Type: TheSite.ManutenzioneCorrettiva.SfogliaRdlPaging1
...
{
  public class SfogliaRdlPaging1 : Page
  {
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      SfogliaRdlPaging1.FunId = this._SiteModule.ModuleId;
      SfogliaRdlPaging1.HelpLink = this._SiteModule.HelpLink;
