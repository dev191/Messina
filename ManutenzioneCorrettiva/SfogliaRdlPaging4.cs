...
// Type: TheSite.ManutenzioneCorrettiva.SfogliaRdlPaging4
...
{
  public class SfogliaRdlPaging4 : Page
  {
    ...
    protected S_ComboBox cmbsStAutorizzaz;
    protected HtmlInputHidden HidSato;
    ...
    private void Page_Load(object sender, EventArgs e)
    {
      ...
      SfogliaRdlPaging4.FunId = this._SiteModule.ModuleId;
      SfogliaRdlPaging4.HelpLink = this._SiteModule.HelpLink;
      ...
      if (!this.Page.IsPostBack)
      {
        ...
        this.BindTipoManutenzione();
        this.BindStatoAutorizz();
        this.DataGridRicerca.Visible = false;
        this.GridTitle1.Visible = false;
    ...
    private void BindUrgenza(string Codice)
    {
      ...
      if (Codice != "")
      {
        ((BaseDataBoundControl) this.cmbsUrgenza).DataSource = (object) GestoreDropDownList.ItemBlankDataSource(new Urgenza().GetPriorita(Convert.ToInt32(Codice), progetto).Tables[0], "DESCRIPTION", "id", "- Selezionare una Urgenza -", "0");
      ...
      {
        ((BaseDataBoundControl) this.cmbsUrgenza).DataSource = (object) GestoreDropDownList.ItemBlankDataSource(new Urgenza().GetPriorita(0, progetto).Tables[0], "DESCRIPTION", "id", "- Selezionare una Urgenza -", "0");
        ((ListControl) this.cmbsUrgenza).DataTextField = "DESCRIPTION";
        ((ListControl) this.cmbsUrgenza).DataValueField = "ID";
        ((Control) this.cmbsUrgenza).DataBind();
      }
    ...
    {
      DataSet stAutorizz = new ClManCorrettiva().GetStAutorizz();
      if (stAutorizz.Tables[0].Rows.Count <= 0)
        return;
      ((BaseDataBoundControl) this.cmbsStAutorizzaz).DataSource = (object) stAutorizz;
      ((ListControl) this.cmbsStAutorizzaz).DataTextField = "descrizione";
      ((ListControl) this.cmbsStAutorizzaz).DataValueField = "id";
      ((Control) this.cmbsStAutorizzaz).DataBind();
    }
    ...
    private void Ricerca(bool reset)
    {
      ...
      ((Control) this.cmbsStAutorizzaz).Visible = true;
      ...
      data1.Add(sObject2);
      DataSet dataSet = correttivaPaging.GetSfogliaRDLPaging4(data1).Copy();
      this.DataGridRicerca.DataSource = (object) dataSet.Tables[0];
      if (reset)
      {
        ((CollectionBase) data1).Clear();
        S_ControlsCollection data2 = this.GetData();
        this.GridTitle1.NumeroRecords = correttivaPaging.GetCount4(data2).ToString();
      }
      this.DataGridRicerca.Visible = true;
      this.GridTitle1.Visible = true;
      ((Control) this.GridTitle1.hplsNuovo).Visible = false;
    ...
    private S_ControlsCollection GetData()
    {
      ...
      ((ParameterObject) sObject18).set_ParameterName("p_status_aut");
      ...
      ((ParameterObject) sObject18).set_Value((object) ((ListControl) this.cmbsStAutorizzaz).SelectedValue);
    ...
    private void DataGridRicerca_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
      ...
      if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
      {
        ...
        ImageButton control4 = (ImageButton) e.Item.Cells[18].FindControl("Imagebutton4");
        ImageButton control5 = (ImageButton) e.Item.Cells[18].FindControl("Imagebutton5");
        ...
        control4.Attributes.Add("title", "Vistare RdL");
        control5.Attributes.Add("title", "Autorizzare RdL");
        control4.Visible = true;
        control5.Visible = true;
        HtmlImage htmlImage1 = new HtmlImage();
        HtmlImage htmlImage2 = new HtmlImage();
        HtmlAnchor control6 = (HtmlAnchor) e.Item.Cells[3].Controls[1];
        HtmlAnchor control7 = (HtmlAnchor) e.Item.Cells[4].Controls[1];
        ...
        {
          control6.HRef = "javascript:openpdf('" + dataItem["WR_ID"].ToString() + "','PREV','" + dataItem["pdfpreventivo"].ToString().Replace("'", "`") + "');";
        ...
        control6.Controls.Add((Control) htmlImage1);
        ...
        {
          control7.HRef = "javascript:openpdf('" + dataItem["WR_ID"].ToString() + "','CONS','" + dataItem["pdfconsuntivo"].ToString().Replace("'", "`") + "');";
        ...
        control7.Controls.Add((Control) htmlImage2);
      }
      ...
      e.Item.Cells[9].Text = "<b>" + this.totpreventivo.ToString("C") + "</b>";
      e.Item.Cells[10].HorizontalAlign = HorizontalAlign.Right;
      e.Item.Cells[10].Text = "<b>" + this.totconsuntivo.ToString("C") + "</b>";
    ...
    private void cmdExcel_Click(object sender, EventArgs e)
    {
      ...
      DataTable dataTable2 = !(((ListControl) this.cmbsTipoManutenzione).SelectedValue == "3") ? this.GetWordExcel().Tables[0].Copy() : new ManCorrettivaPaging().GetSfogliaRDLExcel1(this.GetData()).Copy().Tables[0].Copy();
    ...
    private void DataGridRicerca_ItemCommand(object source, DataGridCommandEventArgs e)
    {
      ...
      {
        this.RegisterStartupScript("Startup1", "<script language=\"JavaScript\">alert(\"" + new ManCorrettivaPaging().UpdateStatusAut(2, int.Parse(e.CommandArgument.ToString())) + "\");<" + "/" + "script>");
        this.Ricerca(false);
      }
      if (!(e.CommandName == "autorizzata"))
        return;
      this.RegisterStartupScript("Startup2", "<script language=\"JavaScript\">alert(\"" + new ManCorrettivaPaging().UpdateStatusAut(3, int.Parse(e.CommandArgument.ToString())) + "\");<" + "/" + "script>");
      this.Ricerca(false);
    }

    private void cmdReset_Click(object sender, EventArgs e) => this.Response.Redirect("SfogliaRdlPaging4.aspx?FunID=" + this.ViewState["FunId"]);
    ...
    private void DataGridRicerca2_ItemCommand(object source, DataGridCommandEventArgs e)
    {
      ...
      string path1 = "CompletaRdl.aspx?wr_id=" + e.Item.Cells[0].Text + str1;
      string path2 = "CompletaRdl.aspx?wr_id=" + e.Item.Cells[0].Text + str1;
      switch (str2)
      {
        case "1":
        case "7":
