...
// Type: TheSite.ManutenzioneCorrettiva.EditApprovaEmetti
...
{
  public class EditApprovaEmetti : Page
  {
    ...
    {
      this._SiteModule = new SiteModule("./ManutenzioneCorrettiva/EditApprovaEmetti.aspx");
